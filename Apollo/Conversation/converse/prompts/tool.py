...
KEY_INFORMATION_EXTRACT_TOOL_DEFINITION = {
    "type": "function",
    "function": {
...
KEY_INFORMATION_EXTRACT_TOOL = {
    "name": "key_information_extract_tool",
    "purpose": "extracts key information values from the user conversation",
    "definition": KEY_INFORMATION_EXTRACT_TOOL_DEFINITION
}


GOAL_DETAILS_EXTRACT_TOOL_DEFINITION = {
    "type": "function",
    "function": {
...
GOAL_DETAILS_EXTRACT_TOOL = {
    "name": "goal_details_extract_tool",
    "purpose": "extracts goal and milestone from user conversation",
    "definition": GOAL_DETAILS_EXTRACT_TOOL_DEFINITION
}


APPOINTMENT_EXTRACT_TOOL_DEFINITION = {
    "type": "function",
    "function": {
        "name": "appointment_extract_tool",
        "description": """
...
APPOINTMENT_EXTRACT_TOOL = {
    "name": "appointment_extract_tool",
    "purpose": "set appointment with doctor tool",
    "definition": APPOINTMENT_EXTRACT_TOOL_DEFINITION
}


CHAT_NORMAL_MODE_SELECTOR_TOOL_DEFINITION = {
    "type": "function",
    "function": {
...
CHAT_NORMAL_MODE_SELECTOR_TOOL = {
    "name": "chat_normal_mode_tool",
    "purpose": "tool used to detect next mode in a normal conversation with user",
    "definition": CHAT_NORMAL_MODE_SELECTOR_TOOL_DEFINITION
}
