...
def APPOINTMENT_OR_PURCHASE_SERVICE_CALL(event_type, event_description, event_contact, event_contact_id, event_date, event_time):
    return {"event_type": event_type, "event_description": event_description, "event_contact": event_contact, "event_contact_id": event_contact_id, "event_date": event_date, "event_time": event_time}
